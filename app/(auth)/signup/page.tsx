...
export default function SignupPage() {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-8" style={{ borderWidth: "0.5px" }}>
      ...
      <form action={action} className="space-y-4">
        <div>
          ...
          <input
            ...
            required
            placeholder="e.g. nomad_hunter"
            className="w-full rounded-lg border px-3 py-2 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-[#1D9E75] transition"
      ...
      <div className="my-4 flex items-center gap-3">
        <div className="flex-1 border-t" style={{ borderWidth: "0.5px" }} />
      ...
      <form action={loginWithGoogle}>
        <button
          type="submit"
          className="w-full flex items-center justify-center gap-2 rounded-lg border py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50"
